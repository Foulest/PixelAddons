...
Only the most recent version of PixelAddons is supported with security updates. Each new release deprecates all older
versions.

## Reporting a Vulnerability

If you discover a vulnerability, please report it using the
[Security section](https://github.com/Foulest/PixelAddons/security) in the GitHub repository.
...
- The version of PixelAddons you are using.
...
Thank you for helping to keep PixelAddons and its users safe!
